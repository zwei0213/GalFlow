...
export const FlowCard: React.FC<FlowCardProps> = ({ card, onReview, sentence }) => {
    ...
    return (
        <div className="w-full h-[100dvh] snap-start flex items-center justify-center relative overflow-hidden group">
            ...
            <div
                ...
                style={{ backgroundImage: card.imagePath ? `url(${card.imagePath})` : undefined }}
            >
                {!card.imagePath && (
            ...
            >
                ...
                <AnimatePresence>
                    {sentence && (
                        ...
                        >
                            <div className="bg-black/60 backdrop-blur-lg border border-white/10 rounded-xl p-6 shadow-2xl relative overflow-hidden">
                                {/* Decor line */}
                                ...
                                <div className="flex flex-col space-y-2">
                                    ...
                                    <p className="text-xl font-jp font-medium leading-relaxed text-white drop-shadow-md">
                                        {sentence.text}
                                    </p>
                                </div>
                            </div>
